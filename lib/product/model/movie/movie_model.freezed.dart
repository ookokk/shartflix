...
class _$MovieModelImpl implements _MovieModel {
  ...
  @override
  String toString() {
    return 'MovieModel(sId: $sId, id: $id, Title: $Title, Year: $Year, Rated: $Rated, Released: $Released, Runtime: $Runtime, Genre: $Genre, Director: $Director, Writer: $Writer, Actors: $Actors, Plot: $Plot, Language: $Language, Country: $Country, Awards: $Awards, Poster: $Poster, Metascore: $Metascore, imdbRating: $imdbRating, imdbVotes: $imdbVotes, imdbID: $imdbID, Type: $Type, Response: $Response, Images: $Images, ComingSoon: $ComingSoon, isFavorite: $isFavorite)';
  }
