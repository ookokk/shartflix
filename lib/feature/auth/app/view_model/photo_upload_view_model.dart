...
import 'package:shartflix/feature/auth/app/state/photo_upload_state.dart';
...
class PhotoUploadViewModel extends AutoDisposeNotifier<PhotoUploadState> {
  PhotoUploadViewModel({required this.uploadPhotoUseCase});
  final UploadPhotoUseCase uploadPhotoUseCase;

  @override
  PhotoUploadState build() => PhotoUploadState();
  ...
  Future<bool> uploadPhoto(BuildContext context, WidgetRef ref) async {
    ...
    final res = await uploadPhotoUseCase.call(state.image!);
